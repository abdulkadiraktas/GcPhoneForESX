...
const defaultLocales = {
  'tr_TR': [
    "Biraz Önce",
      ...
      ["%s week ago", "%s hafta önce"],
      ["%s month ago", "%s ay önce"],
      ["%s year ago", "%s yıl önce"]
  ]
}
export default function install(Vue, { name = 'timeago', locale = 'tr_TR', locales = defaultLocales} = {} ) {
